  ...
  return (
    <li className="pp-contact-row">
      ...
      <div className="pp-contact-actions">
        ...
        {wa && <a className="pp-icon-btn is-wa" href={wa} target="_blank" rel="noopener noreferrer" aria-label={`WhatsApp ${c.name}`} title="WhatsApp"><Icon.Chat width={17} height={17} /></a>}
  ...
  return (
    <div className="pp-page pp-contact-book">
      <ContactGroup
        ...
        badge={<Pill tone="lime">Your child's</Pill>}
        contacts={primary}
      />
      <ContactGroup
      ...
      <p className="pp-foot-note pp-invoice-note">
        <Icon.Clock width={14} height={14} />
        Office hours are 9:00 am to 6:00 pm, Monday to Saturday. For urgent matters outside these hours, WhatsApp the class teacher.
      </p>
    </div>
  );
}
